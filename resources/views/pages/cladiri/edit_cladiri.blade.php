        ...
        <div class="col-md-8">
            <form method="post" action="{{ route('cladiri.update', $cladiri) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nume" value="{{ $cladiri->nume }}" class="form-control @error('nume') is-invalid @enderror" required="">
                        @error('nume')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="nume" name="numar_etaje" value="{{ $cladiri->numar_etaje }}" class="form-control @error('numar_etaje') is-invalid @enderror"  required="">
                        @error('numar_etaje')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
